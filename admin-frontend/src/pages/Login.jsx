...
// Form handling with react-hook-form and zod for validation
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* left panel */}
      <div className="hidden lg:flex lg:w-1/2 bg-primary-light flex-col justify-between px-16 py-14">
        <div>
          <div className="flex items-center gap-1">
            <span className="text-xl font-bold text-primary">Local</span>
            <span className="text-xl font-bold text-secondary">Bites</span>
          </div>
        ...
        <div className="max-w-md">
          <h1 className="text-3xl font-bold text-secondary leading-tight mb-4">
            Full control.
            <br />
            Complete visibility.
          </h1>
